...
echo "<center><h3> SENARAI PRODUK $tajuk </h3></center>";
...
while ( $produk = mysqli_fetch_array( $result ) ) {
    ...
    echo "<td class = 'produk'><img width = 200 src ='../imej/" . $produk[ 'idproduk' ]. ".jpg'><br>
        $produk[namaproduk]<br> RM $produk[harga]<br><br>
        <a class='maklumat' href='produk_maklumat.php?idproduk=$produk[idproduk]'>
        Maklumat </a> &nbsp
        <a class = 'banding' href='bandingan_insert.php?idpembeli=$idpembeli&idproduk=$produk[idproduk]'> Banding </a>
        </td>";
    $bilangan = $bilangan + 1;
    if ( $bilangan % 3 == 0 ) {
        echo '</tr>';
